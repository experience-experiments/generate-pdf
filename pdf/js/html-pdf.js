...
page.onLoadFinished = function (status) {
  ...
  page.paperSize = definePaperSize(getContent(page, options), options)
...
// ------------------------------
function getContent (page, options) {
  ...
  return page.evaluate(function (options) {
    ...
    if ('header' in options) {
      headerContents = document.createElement('div')
      headerContents.innerHTML = options.header.contents
      document.body.appendChild(headerContents)
    }

    var footerContents
    if ('footer' in options) {
      footerContents = document.createElement('div')
      footerContents.innerHTML = options.footer.contents
      document.body.appendChild(footerContents)
    }
    ...
    if (headerContents) document.body.removeChild(headerContents)
    if (footerContents) document.body.removeChild(footerContents)
