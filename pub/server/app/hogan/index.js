...
const layoutPath = path.join(serverPath, 'app/hogan/views')
const assetsPath = path.join(publicPath, 'assets')

const expressHoganCache = require('express-hogan-cache')
...
module.exports = {
  start: function (port) {
    ...
    server.on('listening', () => console.log(`[RMA Generate PDF (Hogan)] ${port}`))
  }
}
